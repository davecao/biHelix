...
-------------
 see ATOM section used in PDB format
    ...
    13    55-63(F8.3)    Phi angle of the residue generated by stride
    14    64-71(F8.3)    Psi angle of the residue generated by stride
    15    72-79(F8.3)    relative ASA area of the residue if available
    16    80-81(A2)    SSE annotation(A2): generated by stride if available
